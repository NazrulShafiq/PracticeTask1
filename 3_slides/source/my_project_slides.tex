...
\begin{frame}{xxx} 
    \begin{figure}[!htp]
        ...
        \includegraphics[width = 0.45\textwidth]{../input/figure_city.jpg}
...
\begin{frame}{xxx}
    \begin{table}[htp]
        ...
        \label{tab:regression_cluster_by_year}
        \resizebox{0.98\textwidth}{!}{\input{../input/table_reg_cluster_year.tex}}
